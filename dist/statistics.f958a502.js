...
})({"aABqd":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "630135eff958a502";
"use strict";
 ...
 * renderCharts();
 */ parcelHelpers.export(exports, "renderCharts", ()=>renderCharts);
...
function renderCharts() {
     ...
     */ const createCharts = (cases, deaths, recovered)=>{
        ...
        mainChart = new (0, _autoDefault.default)(mainChartCanvas, {
            type: 'bar',
            data: {
                labels: [
                    'Cases',
        ...
        pieChart = new (0, _autoDefault.default)(pieChartCanvas, {
            type: 'pie',
            data: {
                labels: [
                    'Active',
     ...
     */ const fetchData = async (disease)=>{
        try {
            ...
            } else if (disease === 'flu') // بيانات افتراضية للإنفلونزا
...
},{}]},["aABqd","WUUf9"], "WUUf9", "parcelRequire1875", {})

//# sourceMappingURL=statistics.f958a502.js.map
